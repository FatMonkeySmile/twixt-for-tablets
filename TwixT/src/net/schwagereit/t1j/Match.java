...
//      setGuiBlocked(false);
    ...
    * @param md Data of new game
    */
   public void updateMatchData(final MatchData md)
   {
      this.matchData = md;
//      RightPanel.getInstance().getEndMatchButton().setEnabled(true);
    ...
    * @return x of move nr
    */
   public int getMoveX(final int nr)
   {
    ...
    * @return y of move nr
    */
   public int getMoveY(final int nr)
   {
...
//               JOptionPane.INFORMATION_MESSAGE);
   ...
   private String getMoveString(final int nr)
   {
      ...
      return new StringBuffer()
            ...
            getMoveNr()).append(".  ").append("" + x + ", " + y).toString();
   }
