...
public final class MatchData implements Cloneable
{
   ...
   public String mdPlayerY = Messages.getString("MatchData.Player") + " 1"; //$NON-NLS-1$
   public String mdPlayerX = Messages.getString("MatchData.Player") + " 2"; //$NON-NLS-1$
   public int mdYsize = Board.DEFAULTDIM;
   public int mdXsize = Board.DEFAULTDIM;
   public boolean mdYhuman = true;
   public boolean mdXhuman = true;
   public boolean mdYstarts = true;
   public final static boolean mdLetterDir = true;
   public boolean mdPieRule = true;
