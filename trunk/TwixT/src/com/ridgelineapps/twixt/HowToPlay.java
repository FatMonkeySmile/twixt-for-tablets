...
public class HowToPlay extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ((Button)findViewById(R.id.how_to_play_ok)).setOnClickListener(new OnClickListener() {
            @Override
        ...
        String html = readFile(this, R.raw.how_to_play).toString();
    ...
    static void show(final Activity activity) {
        ...
        builder.setPositiveButton(R.string.how_to_play_ok, new DialogInterface.OnClickListener() {
        ...
        builder.setMessage(readFile(activity, R.raw.how_to_play));
        builder.create().show();
    }
